    ...
    return (
        <div className='md:py-20 py-6'>
            <div className="container">
                <h1 className='text-center text-4xl font-bold text-gradient bg-gradient-to-r from-blue-500 to-green-300 md:text-6xl items md:px-20 pb-6  bg-clip-text text-transparent'>Build a brand and start selling in seconds</h1>
                <p className="text-center bg-gradient-to-r from-black to-gray-400 bg-clip-text font-bold text-transparent text-lg">No matter what you sell, Bird Software has everything you need to run your online store.</p>
                ...
                <p className="font-bold bg-gradient-to-r from-purple-800 to-gray-300 text-transparent bg-clip-text text-center text-3xl pt-8 pb-12 -mb-8">More than 100+ brands have built their business with Bird Software.</p>
            </div>
            <div className="grid grid-cols-3 gap-y-3 sm:flex pb-8">
                <AnimatePresence
                    ...
                    {image.map((image, index) => (
                        <motion.div
                            ...
                            animate={{
                                ...
                                scale: index === currentImageIndex ? 0.9 : 0.7,
